...
***NOTE***
- Use nc to test the code; since the professor said in lecture that nc is sufficient, we haven't made a client file. Thus, ONLY use nc to the code. Thank you! 
